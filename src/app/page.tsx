  ...
  return (
    <div className="relative min-h-screen text-white flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 w-full">
        {/* ========================================================================= */}
        {/* 1. HERO SECTION (Seamless Circle Fitted University Crest) */}
        {/* ========================================================================= */}
        <section id="hero" className="text-center py-8 sm:py-12 flex flex-col items-center">
          
          {/* Perfectly Fitted Round University Crest with Radial Cyan Glow */}
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-cyan-500/40 bg-cyan-950/40 text-cyan-300 text-xs sm:text-sm font-semibold tracking-wide uppercase mb-4 shadow-[0_0_15px_rgba(6,182,212,0.25)]">
        ...
        {/* ========================================================================= */}
        {/* 2. CAMPUS SHOWCASE BANNER IMAGE */}
        {/* ========================================================================= */}
        ...
        {/* ========================================================================= */}
        {/* 3. MAJORS OVERVIEW SECTION (Properly Masked & Fitted Round Badges) */}
        {/* ========================================================================= */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {MAJORS_DATA.map((major) => {
              ...
              return (
                ...
                >
                  {/* Clean Fitted Round Circular Badge - No White Box Artifacts */}
                  <div
            ...
            <div className="flex-1 overflow-y-auto p-6 sm:p-8 space-y-6">
              <div className="flex flex-wrap items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-500 text-slate-950 font-bold text-xs sm:text-sm uppercase tracking-wide flex items-center justify-center cursor-pointer shadow-[0_0_15px_rgba(6,182,212,0.4)] active:scale-95 transition-all"
                >
                ...
                <Link
                  href="/badge"
                  className="px-4 py-2.5 rounded-xl bg-slate-800/90 border border-cyan-500/30 text-cyan-300 hover:border-cyan-400 font-semibold text-xs sm:text-sm flex items-center gap-2 transition-all ml-auto"
                >
                  GET MEMORY PASS
                </Link>
              </div>
